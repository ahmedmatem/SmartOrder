    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false, comment: "Venue Identifier"),
                    Name = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false, comment: "Venue name"),
                    Type = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false, comment: "Type of the venue(restaurant, pub, cafe, etc.)"),
                    City = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false, comment: "The city where the venue is located"),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false, comment: "Date when the venue was added.")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false, comment: "Menu Category Identifier"),
                    VenueId = table.Column<Guid>(type: "uniqueidentifier", nullable: false, comment: "Venue Identifier"),
                    Title = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false, comment: "Name of the menu category."),
                    Description = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false, comment: "Description of the menu category.")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false, comment: "Table Identifier"),
                    VenueId = table.Column<Guid>(type: "uniqueidentifier", nullable: false, comment: "Venue Identifier"),
                    TableNumber = table.Column<int>(type: "int", nullable: false, comment: "The number of the table"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false, comment: "Menu item Identifier"),
                    MenuCategoryId = table.Column<Guid>(type: "uniqueidentifier", nullable: false, comment: "Item Category Identifier"),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MenuCategories_VenueId",

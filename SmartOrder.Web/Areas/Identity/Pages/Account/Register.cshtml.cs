...
namespace SmartOrder.Web.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            /// </summary>
            [Required]
            [StringLength(100, ErrorMessage = "{0}та трябва да бъде между {2} и {1} знака.", MinimumLength = 4)]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                await _venueService.AddVenueAsync(new VenueViewModel
                {
                ...
                if (result.Succeeded)
                {
                    ...
                    else
                    {
                        ...
                        return LocalRedirect("/Manager/Home/Index");
                    }
                }
